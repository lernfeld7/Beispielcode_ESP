...
const char* mqtt_client_name = "ESP8266-Client";  // beliebig wählbar, muss aber pro Client einmalig sein (wegen Mosquitto); bitte ändern
    
// Topics für Subscription und eigenes Publishing
const char* topic_sub = "some-topic/esp_sub";
const char* topic_pub = "some-topic/esp_pub";
